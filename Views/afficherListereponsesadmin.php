...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Impact</h3>
                </a>
	...
	<body>
	    <button><a href="ajouterreponseadmin.php">Ajouter un reponse</a></button>
		<center><h1>Liste des reponses</h1></center>
		<input type="text" id="search-term" placeholder="Search">
		<button><a href="repoa.php">trier par date</a></button>
		...
		<table class="my-table" border="1" align="center" id="reponse-table">
			...
			<?php foreach($listereponses as $reponse) { ?>
				<tr>
					...
					<td>
						<form method="POST" action="modifierreponseadmin.php">
							<input  type="submit" name="Modifier" value="Modifier">
							<input type="hidden" value=<?PHP echo $reponse['idrep']; ?> name="idrep">
						</form>
					</td>
					<td>
						<a href="supprimerreponseadmin.php?idrep=<?php echo $reponse['idrep']; ?>">Supprimer</a>
					</td>
				</tr>
			<?php } ?>
		</table>
		<br>
		<button><a href="stat.php">voir statistique</a></button>
	</body>
</html>
