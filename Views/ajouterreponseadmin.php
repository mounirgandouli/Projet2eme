<?php
    ...
    if (
        ...
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->Username = "mounir.gandouli@esprit.tn";
        $mail->Password = "211JMT6140";
        // Set the email details
        $mail->setFrom('mounir.gandouli@esprit.tn', 'ADMIN');
       //badal il address hathi bil email ili thib yjik 3alih mathalan mita3 esprit
       $mail->addAddress('mounir.gandouli@esprit.tn', 'CLIENT');
       $mail->Subject = 'Notification de la réponse';
       $mail->Body = 'Ajout de la réponse avec succés!!..Veuillez accéder à votre compte pour voir votre réponse';
        $mail->send();
        }
        else
