...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>We are <span>Impact</span> a Professional web-developers from Tunisia</h2>
          <p>Join us in our mission to promote sustainable transportation and reduce our carbon footprint by choosing an eco bike from Eco Bikes.</p>
          <a href="contact.html" class="btn-get-started">Available to rent and sale</a>
        </div>
      </div>
    </div>
  ...
  <footer id="footer" class="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>ECO-BIKINI</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://Impact.com/">Impact</a>
      </div>
    </div>
  </footer><!-- End Footer -->
